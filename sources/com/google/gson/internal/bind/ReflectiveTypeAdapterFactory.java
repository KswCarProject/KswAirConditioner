            ...
            if (cls != Object.class) {
                ...
                while (true) {
                    ...
                    if (serialize || deserialize) {
                        ...
                        Field field3 = field;
                        i$ = i$3;
                        BoundField boundField = createBoundField(gson, field2, getFieldName(field), TypeToken.get(C$Gson$Types.resolve(type2.getType(), cls, field.getGenericType())), serialize, deserialize);
