...
public class AircShowViewBindingSw600dpMdpiImpl extends AircShowViewBinding {
    @Nullable
    ...
    public AircShowViewBindingSw600dpMdpiImpl(@Nullable DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 14, sIncludes, sViewsWithIds));
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    private AircShowViewBindingSw600dpMdpiImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
