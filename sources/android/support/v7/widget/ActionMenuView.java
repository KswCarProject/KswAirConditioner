    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (true) {
            ...
            if (child.getVisibility() == 8) {
                ...
                int cellsUsed2 = measureChildForCells(child, cellSize, lp.isOverflowButton ? 1 : cellsRemaining, itemHeightSpec, heightPadding2);
        ...
        if (cellsRemaining > 0 && smallestItemsAt != 0 && (cellsRemaining < cellsUsed - 1 || singleItem || maxCellsUsed > 1)) {
            ...
            for (int i9 = 0; i9 < childCount; i9 = i + 1) {
                int i10 = i9;
