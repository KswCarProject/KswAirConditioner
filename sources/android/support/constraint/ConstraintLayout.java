                ...
                if (widget2 != null) {
                    ...
                    if (layoutParams2.isGuideline) {
                        ...
                        if (layoutParams2.circleConstraint != i) {
                            ...
                            int i13 = resolvedLeftToLeft;
                            helperCount = helperCount3;
                            View view2 = child3;
                            float f = resolvedHorizontalBias;
                            int i14 = resolvedRightToRight2;
                            ...
                            if (layoutParams.baselineToBaseline != -1) {
                                ...
                                if (!(target10 == null || view6 == null || !(view6.getLayoutParams() instanceof LayoutParams))) {
                                    ...
                                    baseline.connect(target10.getAnchor(ConstraintAnchor.Type.BASELINE), 0, -1, ConstraintAnchor.Strength.STRONG, 0, USE_CONSTRAINTS_HELPER);
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(android.content.Context r20, android.util.AttributeSet r21) {
            ...
            L_0x012a:
                ...
                int r0 = r2.length()
                if (r0 <= 0) goto L_0x017a
                float r0 = java.lang.Float.parseFloat(r16)     // Catch:{ NumberFormatException -> 0x0179 }
                float r17 = java.lang.Float.parseFloat(r2)     // Catch:{ NumberFormatException -> 0x0179 }
                int r18 = (r0 > r4 ? 1 : (r0 == r4 ? 0 : -1))
                if (r18 <= 0) goto L_0x0178
                int r18 = (r17 > r4 ? 1 : (r17 == r4 ? 0 : -1))
                if (r18 <= 0) goto L_0x0178
                int r3 = r1.dimensionRatioSide     // Catch:{ NumberFormatException -> 0x0179 }
                if (r3 != r6) goto L_0x0170
                float r3 = r17 / r0
                float r3 = java.lang.Math.abs(r3)     // Catch:{ NumberFormatException -> 0x0179 }
            ...
            L_0x017b:
                ...
                float r0 = java.lang.Float.parseFloat(r2)     // Catch:{ NumberFormatException -> 0x018e }
            ...
            L_0x0199:
                ...
                goto L_0x00b1
            L_0x01a7:
                int r0 = r1.matchConstraintMaxHeight     // Catch:{ Exception -> 0x01b1 }
                int r0 = r8.getDimensionPixelSize(r11, r0)     // Catch:{ Exception -> 0x01b1 }
            ...
            L_0x01bc:
                goto L_0x00b1
            L_0x01be:
                int r0 = r1.matchConstraintMinHeight     // Catch:{ Exception -> 0x01c8 }
                int r0 = r8.getDimensionPixelSize(r11, r0)     // Catch:{ Exception -> 0x01c8 }
            ...
            L_0x01d5:
                ...
                goto L_0x00b1
            L_0x01e3:
                int r0 = r1.matchConstraintMaxWidth     // Catch:{ Exception -> 0x01ed }
                int r0 = r8.getDimensionPixelSize(r11, r0)     // Catch:{ Exception -> 0x01ed }
            ...
            L_0x01f8:
                goto L_0x00b1
            L_0x01fa:
                int r0 = r1.matchConstraintMinWidth     // Catch:{ Exception -> 0x0204 }
                int r0 = r8.getDimensionPixelSize(r11, r0)     // Catch:{ Exception -> 0x0204 }
